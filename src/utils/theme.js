...
export const themesKit = {
  ...
  dark: {
    ...
    userInfo: {
      text: tokens.token1[100],
      avatarBackground: tokens.token13[100],
      avatarPicture: tokens.token10[100],
    },
  ...
  light: {
    ...
    userInfo: {
      text: tokens.token11[100],
      avatarBackground: tokens.token17[100],
      avatarPicture: tokens.token1[100],
    },
  ...
  violet: {
    ...
    userInfo: {
      text: tokens.token11[100],
      avatarBackground: tokens.token14[100],
      avatarPicture: tokens.token1[100],
    },
